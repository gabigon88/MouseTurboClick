...
class AutoClickerGUI:
    ...
    def __init__(self, root: tk):
        ...
        self.start_key_combobox.grid(row=6, column=0, sticky="nsew")
        ...
        self.stop_key_combobox.grid(row=6, column=1, sticky="nsew")
        ...
        self.status_label.grid(row=8, column=0, columnspan=2, pady=5, sticky="nsew")
